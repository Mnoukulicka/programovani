...
// Doplňte funkci drawLine, aby nakreslila čáru z bodu pointA do středu mezi body pointA a pointB
...
function drawLine(pointA, pointB) {
    let pt = p5.Vector.sub(pointB, pointA)
    pt.div(2)
    pt.add(pointA)
    line(pointA.x, pointA.y, pt.x, pt.y)
}