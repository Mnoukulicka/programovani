...
// Doplňte funkci drawLine, aby nakreslila čáru se směrem z bodu pointA do body pointB
// ale o pevné délce length (délka čáry bude vždy length)
// Užitečné funkce:
...
function drawLine(pointA, pointB, length) {
      let LINE =createVector()
      LINE = p5.Vector.sub(pointB, pointA)
      LINE.setMag(length)
      LINE.add(pointA)
      line(pointA.x, pointA.y, LINE.x, LINE.y)
}