...
//     }
//     start() {
//         this.rb = this.getComponent(Rigidbod)
...
//         //         .addComponent(new Rect(2, 2))
//         //         .addComponent(new Rigidbody(1, 20))
...
//                 else if (this.srby1 < this.y2) this.objects.splice(this.objects.indexOf(this.object), 1)
//                 this.object++
//             }
...
//                         }
//                     }
//                     if (this.linex < this.srbx2 && this.linex > this.srbx1 && this.liney > this.srby2 && this.liney < this.srby1) this.objects.splice(this.objects.indexOf(this.object), 1); {
//                         this.detection = 0
